...
static void titsc_step_config(struct titsc *ts_dev)
{
	...
	/* 1 бн coordinate_readouts is for X */
	...
	/* coordinate_readouts бн coordinate_readouts * 2 is for Y */
	...
	/* coordinate_readouts * 2 бн coordinate_readouts * 2 + 2 is for Z */
	config = STEPCONFIG_MODE_HWSYNC |
	...
	/* The steps1 бн end and bit 0 for TS_Charge */
