 ...
 *  GET VALUE
 **************************************************************************/
unsigned int shdr_magic(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned char *shdr_cust_name(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_cust_name_len(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_img_ver(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_img_len(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_img_offset(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_sign_len(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_sign_offset(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_sig_len(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
unsigned int shdr_sig_offset(SEC_IMG_HEADER_U *sec_hdr)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
 ...
 *  SET VALUE
 **************************************************************************/
void set_shdr_magic(SEC_IMG_HEADER_U *sec_hdr, unsigned int val)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
void set_shdr_img_ver(SEC_IMG_HEADER_U *sec_hdr, unsigned int ver)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
void set_shdr_cust_name(SEC_IMG_HEADER_U *sec_hdr, unsigned char *name, unsigned int len)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
void set_shdr_sign_len(SEC_IMG_HEADER_U *sec_hdr, unsigned int val)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
...
void set_shdr_sign_offset(SEC_IMG_HEADER_U *sec_hdr, unsigned int val)
{
	switch (sec_ver) {
	case SEC_HDR_V1:
