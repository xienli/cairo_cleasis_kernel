...
TRACE_EVENT(cldma_rx_done,
	    TP_PROTO(int queue_no, unsigned long long rx_interal, unsigned long long total_time,
		     ...
		     unsigned long long sample_rxbytes), TP_ARGS(queue_no, rx_interal, total_time, total_count,
...
TRACE_EVENT(cldma_tx,
	    TP_PROTO(int queue_no, int ccci_ch, unsigned int free_slot, unsigned long long tx_interal,
		     ...
		     unsigned long long sample_txbytes), TP_ARGS(queue_no, ccci_ch, free_slot, tx_interal, tx_cost_time,
...
TRACE_EVENT(cldma_error,
	    ...
	    TP_ARGS(queue_no, ccci_ch, error_no, line_no), TP_STRUCT__entry(__field(int, queue_no)
									    __field(int, ccci_ch)
